...
class NodeBuilder(Model):
    ...
    def _decode(self, output_dict):
        ...
        for spans, span_mask, predicted_node_types, predicted_node_attrs, predicted_node_attr_scores \
                 in zip(spans_batch, span_mask_batch, predicted_node_type_batch, predicted_node_attr_batch, predicted_node_attr_scores_batch):
            node_type_list = []
            ...
            for span, node_type, node_attr, node_attr_scores in zip(spans, predicted_node_types[span_mask], predicted_node_attrs[span_mask], predicted_node_attr_scores[span_mask]):
